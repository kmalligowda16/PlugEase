...
const AddStations = async(req,res)=>{ 
    ...
    try
    {
        ...
        let finalSupportedVehicles = [];
        if (supportedVehicles == "Both") 
        {
          finalSupportedVehicles = ["car", "scooter"];
        }
        else
        {
          finalSupportedVehicles = [supportedVehicles.toLowerCase()];
        }
        ...
        const newStation = new Stations({
            ...
            slots,
            supportedVehicles : finalSupportedVehicles,
            status,
            opensAt,
            closesAt,
            createdBy : userId
    ...
    catch(error)
    {
        ...
        return res.status(400).json({ success: false, message: "failled at db retry..." });
    }
}
